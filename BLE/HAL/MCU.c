...
void CH57X_BLEInit(void)
{
...
#else
    {
        ...
        for(i = 0; i < 6; i++)
        {
            cfg.MacAddr[i] = Bt_Par_Act.Ble_SelfMac[i]; // 使用芯片mac地址
        }
    }
#endif
    ...
    printf("MAC:%02X %02X %02X %02X %02X %02X\r\n",cfg.MacAddr[0],
            ...
            cfg.MacAddr[4],
            cfg.MacAddr[5]);
    Bt_Par_Act.Ble_SelfMac[0] = cfg.MacAddr[0];
    Bt_Par_Act.Ble_SelfMac[1] = cfg.MacAddr[1];
    Bt_Par_Act.Ble_SelfMac[2] = cfg.MacAddr[2];
    Bt_Par_Act.Ble_SelfMac[3] = cfg.MacAddr[3];
    Bt_Par_Act.Ble_SelfMac[4] = cfg.MacAddr[4];
    Bt_Par_Act.Ble_SelfMac[5] = cfg.MacAddr[5];
//    tmos_memcpy(Bt_Par_Act.Ble_SelfMac, cfg.MacAddr, 6);
}
